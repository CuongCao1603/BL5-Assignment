        ...
        <table class="table table-striped">
            ...
            <tbody>
                ...
                <tr>
                    ...
                    <td><%=b.getLocation()%></td>
                    <td>
                        <a href="edit_products.jsp?id=<%=b.getProductId()%>" class="btn btn-sm btn-primary"><i class="fas fa-edit"></i> Edit</a>
                        <button Onclick="return ConfirmDelete();">
                            <a href="../delete?id=<%=b.getProductId()%>" class ="btn btn-sm btn-danger"><i class="fas fa-trash-alt"></i> Delete</a></button>
                    </td>
