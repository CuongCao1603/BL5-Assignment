                ...
                <div class="col-md-3">
                    <div class="card crd-ho">
                        ...
                        <div class="card-body text-center">
                            <img alt="" src="kithchenware/lovisong.jpg" style="width: 200px;height: 150px"
                                 class="img-thumblin">
                            <p>Lò vi sóng</p>
                            <p>Hàng quảng châu siêu đẹp</p>
                            <p>Categories:New</p>
                            <div class="row ml-2">
                ...
                <div class="col-md-3">
                    <div class="card crd-ho">
                        ...
                        <div class="card-body text-center">
                            ...
                            <p>Categories:New</p>
                            <div class="row ml-2">
                                <a href="" class="btn btn-success btn-sm ml-5">View</a><!-- comment -->
                                <a href="" class="btn btn-danger btn-sm ml-1">299</a>
                            </div>
                        </div>
                    </div>
