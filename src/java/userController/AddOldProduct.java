...
public class AddOldProduct extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            ProductDtls p = new ProductDtls(productName, madeIn, price, categories,
                    status, fileName, usermail);
            ...
            if (f) {
                String path = getServletContext().getRealPath("") + "kithchenware";
                File file = new File(path);

                part.write(path + File.separator + fileName);
                session.setAttribute("succMsg", "Product Add Successfully");
                response.sendRedirect("sell_product.jsp");
            } else {
